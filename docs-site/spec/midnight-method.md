...
The circuit implementations are in [`packages/contract/src/did.compact`](https://github.com/midnightntwrk/midnight-did/blob/develop/packages/contract/src/did.compact), and the API helpers that call these circuits are in [`packages/api/src/lib.ts`](https://github.com/midnightntwrk/midnight-did/blob/develop/packages/api/src/lib.ts).
