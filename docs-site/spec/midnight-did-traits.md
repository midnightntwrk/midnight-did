...
| Method-specific syntax | ✔ | Defined in [Midnight DID Method §2](/spec/midnight-method#2-midnight-did-syntax); conforms to [RFC3986] and [W3C-DID] requirements. |
...
| Service discovery | ✔ | Indexers/resolvers dependent on Midnight network ([Midnight DID Method §10](/spec/midnight-method#10-discoverability)). |
