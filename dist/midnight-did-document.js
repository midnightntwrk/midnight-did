...
const MidnightVerificationMethodSchema = z
...
}, "Midnight DID only supports OKP (Ed25519/X25519) or EC (Jubjub/P-256/secp256k1) key types"), z.refine((vm) => {
    ...
    return false;
}, "OKP keys must use Ed25519 or X25519 curve; EC keys must use Jubjub, P-256, or secp256k1 curve"), z.refine((vm) => {
