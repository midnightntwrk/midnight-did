...
const targetFile = path.join(packageRoot, 'src', 'managed', 'schnorr', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'schnorr', 'contract', 'index.d.ts');
