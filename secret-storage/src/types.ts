...
export type JubjubPayloadDigest =
  import("@midnight-ntwrk/midnight-did-jubjub-schnorr").JubjubDigest;
export type JubjubSchnorrSignature =
  import("@midnight-ntwrk/midnight-did-jubjub-schnorr").JubjubSchnorrSignature;
