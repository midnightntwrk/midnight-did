...
const targetFile = path.join(packageRoot, 'src', 'managed', 'passport-credential', 'contract', 'index.js');
const targetTypesFile = path.join(packageRoot, 'src', 'managed', 'passport-credential', 'contract', 'index.d.ts');
