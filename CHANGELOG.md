...
- Publish RC and final GitHub Release bodies from the exact reviewed
  Keep-a-Changelog section for the stable base version. Extraction and existing
  release-body verification fail closed before mutation; reruns never edit an
  immutable release body or upload missing assets.
