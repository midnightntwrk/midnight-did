...
describe("api package barrel", () => {
  ...
  it("keeps the package root runtime export surface explicit", async () => {
    ...
    const apiRuntimeExportNames = [
      ...
      "MIDNIGHT_DID_GHCR_ARTIFACT_REPOSITORY",
      "MIDNIGHT_DID_GITHUB_REPOSITORY",
      "MIDNIGHT_DID_NPM_REGISTRY",
      "MIDNIGHT_DID_PACKAGE_NAME",
      "MIDNIGHT_DID_ZK_ARTIFACT_LOCATIONS",
      ...
      "buildWallet",
      "buildWalletAndWaitForFunds",
      "classifyMidnightDidReleaseVersion",
      "configureProviders",
      "contractConfig",
      "createDID",
      "createLogger",
